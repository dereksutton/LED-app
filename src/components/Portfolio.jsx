      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          <motion.div variants={itemVariants}>
            <motion.h1
              className="font-serif-luxury text-5xl lg:text-8xl text-[--luxury-champagne] mb-8 mx-auto"
            ...
            >
              ...
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-[--luxury-champagne] via-[--luxury-rose-gold] to-[--luxury-champagne]">
                Transformations
              </span>
            </motion.h1>
          </motion.div>
        ...
        >
          <div className="bg-gradient-to-r from-slate-800/50 via-slate-700/80 to-slate-800/50 backdrop-blur-sm rounded-2xl p-12 border border-slate-600/30">
            ...
            <motion.a
              href="#quote"
              className="inline-flex h-16 lg:h-20 animate-shimmer items-center justify-center rounded-full border border-[--luxury-champagne]/30
