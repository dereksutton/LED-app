    ...
    return (
        <footer className="bg-slate-500 text-white py-4">
            <div className="container mx-auto text-center px-4">
                <p className="poppins-semibold text-white text-3xl">Follow Us On Social Media!</p>
                ...
                <p className="poppins-regular text-white text-md mt-16">&copy; {new Date().getFullYear()} LED Custom Painting & More. All rights reserved.</p>
            </div>
        </footer>
    );
};
